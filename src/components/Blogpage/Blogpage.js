...
const blogcontent ={
  ...
  title:"React JS, Angular, Next JS, and Vite: Which Framework Should i use in my next Web Development Project?  ",
  ...
  return (
    ...
    {/* Tags  */}
      <div className='flex flex-row mb-2'>
        ...
        {/* Cover image */}
        <img src={blogcontent.image} className='object-cover rounded-lg sm:max-h-96 sm:w-full md:w-9/12 m-6 ms-1 h-full'/>
